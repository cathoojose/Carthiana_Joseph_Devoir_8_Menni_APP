// frontend/screens/Client/LiveTrackingPackageScreen.tsx
...
const LiveTrackingPackageScreen = ({ route, navigation }: Props) => {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setTimeRemaining(prev => {
        if (prev <= 1) {
          clearInterval(timer);
          Alert.alert(t('Livraison terminée'), t('Votre colis est arrivé !'));
  ...
  return (
    <ThemedView>
      ...
      {/* Info du colis */}
      <View style={[styles.packageInfo, { backgroundColor: theme.background, borderColor: theme.border }]}>
        <Text style={[styles.packageTitle, { color: theme.text }]}>
          {t('Information du colis')}
        </Text>
      ...
      {/* Info du livreur */}
      <View style={[styles.driverInfo, { backgroundColor: theme.background, borderColor: theme.border }]}>
...
export default LiveTrackingPackageScreen;
